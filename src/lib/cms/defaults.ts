...
export const DEFAULT_CMS: CmsContent = {
  ...
  home: {
    ...
    tiersSection: {
      ...
      offer: {
        ...
        addonPrice: "",
        totalSaving: "",
        recurringTerms: "Then £79 / month rolling after 8 weeks",
        offerEnd: "",
        placesRemaining: "",
      },
      guarantee: {
  ...
  tiers: [
    ...
    },
    {
      ...
      billingLabel: "£149 · then £79 / month rolling after 8 weeks",
    },
    {
      id: "performance-analysis",
      enabled: true,
      highlight: false,
      name: "TFP Performance Analysis",
      badge: "",
      subhead: "One-off deep dive",
      body: [
        "A full performance read on where you are now.",
        "Clear priorities. No fluff.",
        "Self-serve checkout.",
      ],
      includes: [
      ...
      cta: {
        kind: "checkout",
        label: "Book the Analysis",
        href: "",
      },
      applyBadge: "",
      ...EMPTY_TIER_COMMERCE,
      priceAmount: 1499,
      billingLabel: "£1,499 · one-off",
    },
    {
      id: "performance",
      enabled: true,
      highlight: false,
      name: "TFP Performance",
      badge: "",
      subhead: "6-month programme",
      body: [
        "Structure, accountability, and coaching that sticks.",
        "Built for consistent progress over six months.",
      ],
      includes: [
      ...
      recurringInterval: "month",
      recurringMonths: 6,
      billingLabel: "£1,499 · then £299 / month for 6 months",
    },
    {
      id: "pro",
      enabled: true,
